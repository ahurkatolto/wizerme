...
// @description  A big pile of crap useful for cheating on worthless wizer.me tests.
...
var obj;
fetch("https://app.wizer.me/learn/worksheet/" + window.location.href.split("/")[4]).then(response => response.json()).then(data => obj = data); // console.log(objj.worksheet.sessionId);
